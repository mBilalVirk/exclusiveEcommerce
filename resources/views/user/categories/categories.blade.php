        ...
        <div class="flex flex-col md:flex-row md:items-end gap-10 lg:gap-20 justify-between">
            ...
            <div>
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <span class="text-red-500 font-bold text-sm">Categories</span>
                </div>
                <h2 class="text-3xl md:text-4xl font-bold tracking-tight">Browse By Category</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 lg:gap-8">
                ...
                <a href="/shop?category=smartwatch"
                    ...
                    <svg class="w-12 h-12 mb-4" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        ...
                        <path d="M9 18v3h6v-3M9 6V3h6v3"></path>
                    </svg>
