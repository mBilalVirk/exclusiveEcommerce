<div class="max-w-6xl mx-auto px-4 py-10 font-sans">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
        <div class="flex flex-col md:flex-row md:items-end gap-10 lg:gap-20">
            <div>
                <div class="flex items-center gap-4 mb-4">
                    <div class="w-5 h-10 bg-red-500 rounded-sm"></div>
                    <span class="text-red-500 font-bold text-sm">Today's</span>
                </div>
                <h2 class="text-3xl md:text-4xl font-bold tracking-tight">Flash Sales</h2>
            </div>
        ...
        <div class="flex gap-2">
            <button id="flash-prev"
                class="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition">
    ...
    {{-- <div class="swiper flashsales-swiper">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 swiper-wrapper" id="flashsales-grid">


            <div class="group">
                <div class="relative bg-gray-100 rounded-sm h-[250px] flex items-center justify-center overflow-hidden">
                    <span class="absolute top-3 left-3 bg-red-500 text-white text-xs px-3 py-1 rounded-sm">-40%</span>
                    ...
                    <img src="image/g92-2-500x500.png" alt="Gamepad"
                ...
                <div class="mt-4">
                    <h3 class="font-bold text-base truncate">HAVIT HV-G92 Gamepad</h3>
            ...
            <div class="group">
                <div class="relative bg-gray-100 rounded-sm h-[250px] flex items-center justify-center overflow-hidden">
                    ...
                    <img src="image/ak-900-01-500x500.png" alt="Gamepad"
                        class="object-contain max-h-[180px] group-hover:scale-110 transition duration-300">
                ...
                <div class="mt-4">
                    <h3 class="font-bold text-base truncate">AK-900 Wired Keyboard</h3>
                    <div class="flex items-center gap-3 mt-2">
                    ...
                    <div class="flex items-center gap-2 mt-2">
                        <div class="flex text-yellow-400">★★★★</div>
                        <span class="text-gray-400 text-sm font-bold">(73)</span>
                    </div>
                </div>
            </div>
            ...
            <div class="group">
                <div
                    ...
                    <span class="absolute top-3 left-3 bg-red-500 text-white text-xs px-3 py-1 rounded-sm">-30%</span>
                    ...
                    <img src="image/led-tv.png" alt="Gamepad"
                        class="object-contain max-h-[180px] group-hover:scale-110 transition duration-300">
                ...
                <div class="mt-4">
                    <h3 class="font-bold text-base truncate">IPS LCD Gaming Monitor</h3>
                    <div class="flex items-center gap-3 mt-2">
            ...
            <div class="group">
                <div
                    ...
                    <img src="image/chairs.png" alt="Gamepad"
                        class="object-contain max-h-[180px] group-hover:scale-110 transition duration-300">
                ...
                <div class="mt-4">
                    <h3 class="font-bold text-base truncate">S-Series Comfort Chair </h3>
                    <div class="flex items-center gap-3 mt-2">
                        <span class="text-red-500 font-bold">$370</span>
                        <span class="text-gray-400 line-through">$400</span>
                    </div>
        ...
        <!-- Navigation -->
        <div id="flash-prev" class="swiper-button-prev"></div>
        <div id="flash-next" class="swiper-button-next"></div>
    </div> --}}
    <div class="swiper flashsales-swiper">
        <div id="flashsales-grid" class="swiper-wrapper"></div>
    ...
    <div class="w-full flex justify-center mt-6">
        <a href="/shop"
            class="inline-block bg-red-500 text-white font-semibold px-6 py-3 rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 transition-colors duration-200 cursor-pointer">
            View All Products
        </a>
    </div>

    <hr class="border-t border-gray-300 my-6 mx-6" />
    @vite('resources/js/flashsales.js')
</div>
