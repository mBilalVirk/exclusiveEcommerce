<div class="max-w-6xl mx-auto px-4 py-10 font-sans">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" id="products-grid">
        ...
        {{-- <div class="group">
            <div class="relative bg-gray-100 rounded-sm h-[250px] flex items-center justify-center overflow-hidden">
                ...
                <img src="image/Breed Dry Dog Food.png" alt="Breed Dry Dog Food"
            ...
            <div class="mt-4">
                <h3 class="font-bold text-base truncate">Breed Dry Dog Food</h3>
                <div class="flex items-center gap-3 mt-2">
                    <span class="text-red-500 font-bold">$140</span>
                    <span class="text-gray-400 line-through">$140</span>
                </div>
        ...
        <div class="group">
            <div class="relative bg-gray-100 rounded-sm h-[250px] flex items-center justify-center overflow-hidden">
                ...
                <img src="image/CANON EOS DSLR Camera.png" alt="CANON EOS DSLR Camera"
                    class="object-contain max-h-[180px] group-hover:scale-110 transition duration-300">
            ...
            <div class="mt-4">
                <h3 class="font-bold text-base truncate">CANON EOS DSLR Camera</h3>
                <div class="flex items-center gap-3 mt-2">
                ...
                <div class="flex items-center gap-2 mt-2">
                    <div class="flex text-yellow-400">★★★★</div>
                    <span class="text-gray-400 text-sm font-bold">(93)</span>
                </div>
            </div>
        </div>
        ...
        <div class="group">
            <div class="relative bg-gray-100 rounded-sm h-[250px] flex items-center justify-center overflow-hidden">
                ...
                <img src="image/ASUS FHD Gaming Laptop.png" alt="ASUS FHD Gaming Laptop"
                    class="object-contain max-h-[180px] group-hover:scale-110 transition duration-300">
            ...
            <div class="mt-4">
                <h3 class="font-bold text-base truncate">ASUS FHD Gaming Laptop</h3>
                <div class="flex items-center gap-3 mt-2">
                    <span class="text-red-500 font-bold">$70</span>
                    <span class="text-gray-400 line-through">$700</span>
                </div>
                <div class="flex items-center gap-2 mt-2">
                    <div class="flex text-yellow-400">★★★★★</div>
        ...
        <div class="group">
            <div class="relative bg-gray-100 rounded-sm h-[250px] flex items-center justify-center overflow-hidden">
                ...
                <img src="image/Curology Product Set.png" alt="Gamepad"
                    class="object-contain max-h-[180px] group-hover:scale-110 transition duration-300">
            ...
            <div class="mt-4">
                <h3 class="font-bold text-base truncate">Curology Product Set </h3>
                <div class="flex items-center gap-3 mt-2">
                    <span class="text-red-500 font-bold">$370</span>
                    <span class="text-gray-400 line-through">$370</span>
                </div>
                <div class="flex items-center gap-2 mt-2">
                    <div class="flex text-yellow-400">★★★★★</div>
                    <span class="text-gray-400 text-sm font-bold">(88)</span>
    ...
    <div class="swiper products-swiper">
        <div id="products-grid" class="swiper-wrapper"></div>
